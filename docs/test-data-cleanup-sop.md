...
- v0.7.0 到 v0.8.1 生产 smoke 使用 `codex.v070.*@example.com`、`codex.v071.*@example.com`、`codex.v072.*@example.com`、`codex.v073.*@example.com`、`codex.v074.*@example.com`、`codex.v075.*@example.com`、`codex.v076.*@example.com`、`codex.v077.*@example.com`、`codex.v080.*@example.com`、`codex.v081.*@example.com` 临时 Auth 用户；清理前必须先预览命中列表。
- v0.7.0 到 v0.8.1 smoke 可能留下 `codex-v070-`、`codex-v071-`、`codex-v072-`、`codex-v073-`、`codex-v074-`、`codex-v075-`、`codex-v076-`、`codex-v077-`、`codex-v080-`、`codex-v081-` 测试附件；必须通过 Storage 控制台删除，不能直接 SQL 删除 `storage.objects`。
...
with test_users as (
  ...
  where email like 'codex.v02.%@example.com'
     ...
     or email like 'codex.v069.%@example.com'
     or email like 'codex.v070.%@example.com'
     or email like 'codex.v071.%@example.com'
     or email like 'codex.v072.%@example.com'
     ...
     or email like 'codex.v077.%@example.com'
     or email like 'codex.v080.%@example.com'
     or email like 'codex.v081.%@example.com'
...
where objects.name ilike '%device-smoke-%'
   ...
   or objects.name ilike '%codex-v069-%'
   or objects.name ilike '%codex-v070-%'
   or objects.name ilike '%codex-v071-%'
   or objects.name ilike '%codex-v072-%'
   ...
   or objects.name ilike '%codex-v077-%'
   or objects.name ilike '%codex-v080-%'
   or objects.name ilike '%codex-v081-%'
   or exists (
...
where users.email like 'codex.v02.%@example.com'
   ...
   or users.email like 'codex.v069.%@example.com'
   or users.email like 'codex.v070.%@example.com'
   or users.email like 'codex.v071.%@example.com'
   or users.email like 'codex.v072.%@example.com'
   ...
   or users.email like 'codex.v077.%@example.com'
   or users.email like 'codex.v080.%@example.com'
