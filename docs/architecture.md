...
- Continue using `docs/test-data-cleanup-sop.md` for `codex.v073.*` through `codex.v080.*` and matching `codex-v073-*` through `codex-v080-*` temporary data.
